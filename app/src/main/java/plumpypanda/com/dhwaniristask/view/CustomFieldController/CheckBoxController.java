...
public class CheckBoxController extends LabeledFieldController {
     ...
     */
    public CheckBoxController(Context ctx, String name, String labelText, Set<InputValidator> validators, List<String> items, boolean useItemsAsValues,String labelNo) {
        this(ctx, name, labelText, validators, items, useItemsAsValues ? items : null,labelNo);
    }
     ...
     */
    public CheckBoxController(Context ctx, String name, String labelText, Set<InputValidator> validators, List<String> items, List<?> values,String labelNo) {
     ...
     *                         represent the selected item
     */
    public CheckBoxController(Context ctx, String name, String labelText, boolean isRequired, List<String> items, boolean useItemsAsValues,String labelNo) {
        this(ctx, name, labelText, isRequired, items, useItemsAsValues ? items : null,labelNo);
    }
     ...
     *                   the same order as the {@code items}.
     */
    public CheckBoxController(Context ctx, String name, String labelText, boolean isRequired, List<String> items, List<?> values,String labelNo) {
