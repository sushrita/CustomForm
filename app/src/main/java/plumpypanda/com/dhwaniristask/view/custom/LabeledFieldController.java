...
public abstract class LabeledFieldController extends FormElementController {
     ...
     */
    public LabeledFieldController(Context ctx, String name, String labelText, boolean isRequired,String labelNo) {
        this(ctx, name, labelText, new HashSet<InputValidator>(),labelNo);
     ...
     */
    public LabeledFieldController(Context ctx, String name, String labelText, Set<InputValidator> validators,String labelNo) {
        super(ctx, name);
    ...
    protected View createView() {
        ...
        TextView labelNumber = (TextView)view.findViewById(R.id.tvLabelNo);
        if (labelNo == null) {
            labelNumber.setVisibility(View.GONE);
        } else {
            labelNumber.setText(labelNo);
        }
